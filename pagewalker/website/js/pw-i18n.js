(function () {
  ...
  var DICT = {
    en: {
      ...
      "home.metaDescription": "Pagewalker — discover books, track reading, join book clubs, and connect with readers. Download free on Google Play.",
      "home.heroLine1": "Walk your shelves.",
      "home.heroLine2": "Share the story.",
      "home.heroLede": "Your cozy corner for TBR piles, reading streaks, spicy reviews, and book-club chaos — built for your phone, not your browser tab.",
      "home.playAlt": "Get it on Google Play",
      "home.heroTagline": "Free on Google Play · your shelf lives in your pocket",
      ...
      "marketing.getApp": "Get the app",
      "marketing.inApp": "In the app",
      "marketing.promiseKicker": "The app",
      "marketing.promiseHeading": "A reading home worth opening every day",
      "marketing.promiseBody": "Track what you read, discover what's next, roast or rave in reviews, and argue about endings in book clubs — all in one place on your phone.",
      "marketing.ctaHeading": "Your next chapter starts in the app",
      "marketing.ctaLede": "Download PageWalker free on Google Play. Subscriptions and premium features live in the app.",
      "marketing.gate.title": "PageWalker lives on your phone",
      "marketing.gate.body": "Library, discover, reviews, clubs, and reading tools — download the app to dive in.",
      "marketing.gate.home": "Back to home",
      "marketing.gate.section": "This feature",
      "marketing.gate.book": "Book pages",

      "marketing.feTagline": "Discover your next world",
      "marketing.feDownload": "Download on Android",
      "marketing.feIosSoon": "iOS coming soon",
      "marketing.feScroll": "scroll to explore ↓",
      "marketing.feDiscovering": "Now discovering",
      "marketing.feSkip": "skip →",
      "marketing.whatsNewHeading": "Fresh in the app",
      "marketing.whatsNewTease1": "Pick your language in the app settings.",
      "marketing.whatsNewTease2": "Discovery, TBR stacks, sessions, reviews, and book clubs.",
      "marketing.whatsNewFoot": "Update the app to try the latest — details on our updates page.",
      ...
      "updates.i1.body": "Pagewalker now lives at its own address under the stars — a deep-space site built to send you to the app.",
    ...
    hu: {
      ...
      "home.metaDescription": "Pagewalker — könyvek felfedezése, olvasáskövetés, könyvklubok. Töltsd le ingyen a Google Play-ről.",
      "home.heroLine1": "Járd be a polcaidat.",
      "home.heroLine2": "Oszd meg a történetet.",
      "home.heroLede": "A TBR-ed, olvasási sorozataid, forró értékeléseid és könyvklub-káoszod — telefonra építve, nem böngészőfülre.",
      "home.playAlt": "Letöltés a Google Play-ről",
      "home.heroTagline": "Ingyenes a Google Play-en · a polcod a zsebedben van",
      "home.readerBuzzExplainer":
      ...
      "marketing.getApp": "Töltsd le az appot",
      "marketing.inApp": "Az appban",
      "marketing.promiseKicker": "Az app",
      "marketing.promiseHeading": "Egy olvasási otthon, amit minden nap megnyitsz",
      "marketing.promiseBody": "Kövesd az olvasásodat, fedezz fel újat, írj értékeléseket, és vitatkozz a végkifejleten klubban — minden a telefonodon.",
      "marketing.ctaHeading": "A következő fejezeted az appban kezdődik",
      "marketing.ctaLede": "Töltsd le a PageWalkert ingyen a Google Play-ről. Az előfizetések és prémium funkciók az appban vannak.",
      "marketing.gate.title": "A PageWalker a telefonodon él",
      "marketing.gate.body": "Könyvtár, felfedezés, értékelések, klubok és olvasó eszközök — töltsd le az appot.",
      "marketing.gate.home": "Vissza a kezdőlapra",
      "marketing.gate.section": "Ez a funkció",
      "marketing.gate.book": "Könyvoldalak",

      "marketing.feTagline": "Fedezd fel a következő világod",
      "marketing.feDownload": "Letöltés Androidra",
      "marketing.feIosSoon": "iOS hamarosan",
      "marketing.feScroll": "görgess a felfedezéshez ↓",
      "marketing.feDiscovering": "Épp felfedezünk",
      "marketing.feSkip": "kihagyás →",
      "marketing.whatsNewHeading": "Friss az appban",
      "marketing.whatsNewTease1": "Válaszd ki a nyelvet az app beállításaiban.",
      "marketing.whatsNewTease2": "Felfedezés, TBR polcok, szessziók, értékelések és könyvklubok.",
      "marketing.whatsNewFoot": "Frissítsd az appot a legújabb funkciókért — részletek a frissítések oldalon.",
      ...
      "updates.i1.body": "A Pagewalker mostantól saját címen él a csillagok alatt — mélyűr kinézet, ami az appba vezet.",
